...
export default new Router({
  ...
  routes: [
    ...
    {
      path: "/create-account",
      redirect: "/create-account/personal",
      component: () => import("@/view/pages/create_account/Layout.vue"),
      children: [
        {
          path: "/create-account/personal",
          name: "create-account-personal",
          component: () => import("@/view/pages/create_account/Personal.vue")
        },
        {
          path: "/create-account/company",
          name: "create-account-company",
          component: () => import("@/view/pages/create_account/Company.vue")
        },
      ]
    },
    // LOGIN ROUTE
